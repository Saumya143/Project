...
<body>
<h1 style="text-align: center;color: blue">VEICHLE REGISTRATION DETAILS </h1>

<div class="text-center bg-primary text-white " style="height:50px;">
		<label style="margin-top:1%;">Veichle Registration Details</label>
	</div>
	<div class="d-flex justify-content-center mt-4 table-responsive">
   <form:form action="/veclReg/${ownerId}" method="POST"
	modelAttribute="veclReg">

	<table>   
		
		<tr>
			<td>REG CENTER</td>
			<td><form:input path="regCenter" class="form-control" /></td>
		</tr>
		<tr>
			<td>REG DATE</td>
			<td><form:input path="regDate" id="datepicker" class="form-control"/></td>
		</tr>
