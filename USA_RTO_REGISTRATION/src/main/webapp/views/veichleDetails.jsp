...
<body>
<h1 style="text-align: center;color: blue">VEICHLE  DETAILS </h1>

<div class="text-center bg-primary text-white " style="height:50px;">
		<label style="margin-top:1%;">Veichle  Details</label>
	</div>
	<div class="d-flex justify-content-center mt-4 table-responsive">
   <form:form action="/veclForm/${ownerId}" method="POST"
	modelAttribute="veclDetails">

	<table>   
		
		<tr>
			<td>VEICHLE TYPE</td>
			<td><form:input path="veichleType" class="form-control" /></td>
		</tr>
		<tr>
			<td>MFG YEAR</td>
			<td><form:input path="mfgYear" class="form-control"/></td>
		</tr>

		<tr>
			<td>VEICHLE BRAND</td>
			<td><form:input path="veclBrand" class="form-control"/></td>
		</tr>
