...
<ul class="nav justify-content-center" id="myTab">
  ...
  <li class="nav-item">
    ...
    <div class="dropdown-menu">
      ...
      <a class="dropdown-item" href="#">View Agencies</a>
      <a class="dropdown-item" href="#">view Admin`s</a>
      <a class="dropdown-item" href="#">view Users</a>
      <a class="dropdown-item" href="#">Active/De-active Account</a>
      <a class="dropdown-item" href="#">view Tags</a>
      <a class="dropdown-item" href="#">Active/De-active Agencyt</a>
    </div>
  </li>
  <li class="nav-item">
